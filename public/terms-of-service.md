# THE MASSACHUSETTS CODING LEAGUE WEBSITE'S TERMS OF SERVICE

Last Updated: **December 25, 2023**

These terms of service ("Terms") apply to your access and use of the Massachusetts Coding League website (the "Service"). Please read them carefully.

## Accepting these Terms

If you access or use the Service, it means you agree to be bound by all of the terms below. So, before you use the Service, please read all of the terms. If you don't agree to all of the terms below, please do not use the Service. Also, if a term does not make sense to you, please let us know by e-mailing [macodingleague@gmail.com](mailto:macodingleague@gmail.com) or by creating a Discussion on the GitHub repository linked in the navigation bar.

## Changes to these Terms

We reserve the right to modify these Terms at any time. For instance, we may need to change these Terms if we come out with a new feature or for some other reason.

Whenever we make changes to these Terms, the changes are effective immediately after we post such revised Terms. (indicated by revising the date at the top of these Terms) It is your responsibility to check this page for changes to these Terms. We may post a prominent banner at the top of the website when changes are made.
...
## The Massachusetts Coding League website's Materials
...
The Massachusetts Coding League website makes no claim or representation regarding, and accepts no responsibility for third party websites accessible by hyperlink from the Service or websites linking to the Service. When you leave the Service, you should be aware that these Terms and our policies no longer govern.
...
IN NO EVENT WILL THE MASSACHUSETTS CODING LEAGUE WEBSITE BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY SPECIAL, INDIRECT, INCIDENTAL, EXEMPLARY OR CONSEQUENTIAL DAMAGES OF ANY KIND ARISING OUT OF OR IN CONNECTION WITH THE SERVICE OR ANY OTHER SERVICE AND/OR CONTENT INCLUDED ON OR OTHERWISE MADE AVAILABLE TO YOU THROUGH THE SERVICE, REGARDLESS OF THE FORM OF ACTION, WHETHER IN CONTRACT, TORT, STRICT LIABILITY OR OTHERWISE, EVEN IF WE HAVE BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGES OR ARE AWARE OF THE POSSIBILITY OF SUCH DAMAGES. OUR TOTAL LIABILITY FOR ALL CAUSES OF ACTION AND UNDER ALL THEORIES OF LIABILITY WILL BE LIMITED TO THE AMOUNT YOU PAID TO THE MASSACHUSETTS CODING LEAGUE WEBSITE. THIS SECTION WILL BE GIVEN FULL EFFECT EVEN IF ANY REMEDY SPECIFIED IN THIS AGREEMENT IS DEEMED TO HAVE FAILED OF ITS ESSENTIAL PURPOSE.
...
These Terms constitute the entire agreement between you and the Massachusetts Coding League website regarding the use of the Service, superseding any prior agreements between you and the Massachusetts Coding League website relating to your use of the Service.

## Feedback

Please let us know what you think of the Service, these Terms and, in general, of the Massachusetts Coding League website. When you provide us with any feedback, comments or suggestions about the Service, these Terms and, in general, of the Massachusetts Coding League website, you irrevocably assign to us all of your right, title and interest in and to your feedback, comments and suggestions.

## Questions & Contact Information

Questions or comments about the Service may be directed to us at the email address [macodingleague@gmail.com](mailto:macodingleague@gmail.com).
